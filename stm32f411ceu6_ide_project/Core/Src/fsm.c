...
//		Current State			Event			Next State
		...
		{SET_ALARM_LIMIT_TEMP, 	DOWN, 			SET_ALARM_DELAY_TEMP},
		{SET_ALARM_LIMIT_TEMP, 	PRESSED, 		SET_ALARM_DELAY_TEMP},
		{SET_ALARM_DELAY_TEMP, 	UP, 			SET_ALARM_LIMIT_TEMP},
		{SET_ALARM_DELAY_TEMP, 	DOWN, 			SET_ALARM_TEMP_BACK},
		{SET_ALARM_DELAY_TEMP, 	PRESSED, 		SET_ALARM_DELAY_TEMP_CHOOSE},
		{SET_ALARM_TEMP_BACK, 	UP, 			SET_ALARM_DELAY_TEMP},
